                        ...
                        <h2>Your Dashboard</h2>
                            ...
                            <div v-for="user in users" class="single-card">
                                ...
                                <div class="card" style="width: 18rem;">
                                    <div class="card-body">
                                        <h5 class="card-title"><router-link class="card-link" v-bind:to="  '/users/' + user.id + '/new/journey'"><i class="fa fa-plus" aria-hidden="true"></i><h6>New Journey</h6></router-link></h5>
